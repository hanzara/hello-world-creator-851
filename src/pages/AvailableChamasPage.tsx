...
const AvailableChamasPage: React.FC = () => {
  ...
  const handlePayment = async () => {
    ...
    const purchaseAmount = calculatePrice(selectedChama.max_members);
        ...
        <Dialog open={showPaymentDialog} onOpenChange={setShowPaymentDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Pay KES {selectedChama && calculatePrice(selectedChama.max_members)} to purchase {selectedChama?.name}
              </DialogDescription>
            </DialogHeader>
              ...
              <div className="bg-primary/10 p-4 rounded-lg space-y-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-lg text-primary">
                    KES {selectedChama && calculatePrice(selectedChama.max_members)}
                  </span>
                </div>
              </div>
